...
class ConfigController extends AbstractController
{
    ...
    protected function executeIndex()
    {
        ...
        foreach ($testmodals as $modal_id) {
            $modal = new Modal($this->twig, 'test' . ucfirst($modal_id), Modal::MODAL_TYPE_OKCANCEL);
            $this->addModal($modal);
    ...
    protected function getLabels()
    {
        return array(
            ...
            'label_tab_glip' => psm_get_lang('config', 'tab_glip'),
            'label_settings_email' => psm_get_lang('config', 'settings_email'),
            'label_settings_sms' => psm_get_lang('config', 'settings_sms'),
            'label_settings_pushover' => psm_get_lang('config', 'settings_pushover'),
            'label_settings_glip' => psm_get_lang('config', 'settings_glip'),
            ...
            'label_glip_description' => psm_get_lang('config', 'glip_description'),
            'label_glip_status' => psm_get_lang('config', 'glip_status'),
            ...
            'label_log_glip' => psm_get_lang('config', 'log_glip'),
